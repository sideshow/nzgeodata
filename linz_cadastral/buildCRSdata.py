...
def main():
    ...
    dbcur.execute("""
        ...
        create table crs_road_name (id integer not null primary key, alt_id integer null, type varchar not null, name varchar not null, location varchar null, status varchar not null, unofficial_flag char not null, audit_id serial not null);
		...
		create table crs_title (title_no varchar NOT NULL, ldt_loc_id integer NOT NULL, status varchar NOT NULL, issue_date date NOT NULL, register_type varchar NOT NULL,type varchar NOT NULL, audit_id serial NOT NULL, ste_id integer NOT NULL, guarantee_status varchar NOT NULL, provisional char NOT NULL, sur_wrk_id integer NULL, ttl_title_no_srs varchar NULL);
